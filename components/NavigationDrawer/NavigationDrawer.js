...
const NavigationDrawer = () => {
  ...
  const defaultStyle =
    "h-full fixed bg-white dark:bg-gray-800 w-96 z-30 top-0 shadow-lg p-4 transform -translate-x-96 transition-all duration-500 ease-in-out dark:text-white";
  const activeStyle =
    "h-full fixed bg-white dark:bg-gray-800 w-96 z-30 top-0 shadow-lg p-4 transform transition-all duration-500 ease-in-out dark:text-white";
