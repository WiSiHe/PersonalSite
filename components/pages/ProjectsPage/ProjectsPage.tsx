        ...
        <>
            <section className="relative grid h-full grid-cols-12 gap-4 p-4">
                <div className="col-span-full xl:col-span-8">
                    <h1>My Projects</h1>
                    <p>
                        Discover a collection of my ongoing and completed
                        projects, each with unique learning experiences.
                    </p>
                </div>
                ...
                {projects
                    ...
                    .map((project) => {
                        ...
                        return (
                            <div
                                className={clsx(
                                    "col-span-full xl:col-span-3 overflow-clip rounded h-full drop-shadow-lg",
                                )}
                                key={_id}
                            >
                                <Project {...project} />
