        ...
        <section className="relative grid grid-cols-12">
          ...
          <section className="relative col-span-12 p-4 pt-10 xl:col-span-10">
            <div className="relative grid grid-cols-8 gap-10 py-10">
              ...
              <article className="relative flex flex-col bg-white rounded-lg shadow-xl xl:col-span-6 xl:flex-row col-span-full xl:h-96">
                ...
                <div className="relative order-1 w-full transition-all h-96 xl:h-full xl:order-2 xl:transform xl:translate-x-20 xl:translate-y-32 xl:scale-125">
                  <Image
                    src={portrait}
                    alt="test"
